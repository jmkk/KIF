Pod::Spec.new do |s|
  ...
  s.source          = { :git => "https://github.com/kif-framework/KIF.git", :tag => "v3.2.3.2" }
  s.platform        = :ios, '5.1'
  ...
  s.subspec 'XCTest' do |xctest|
    ...
    xctest.public_header_files  = 'Classes/**/*.h', 'Additions/**/*-KIFAdditions.h', 'Additions/UIView-Debugging.h'
